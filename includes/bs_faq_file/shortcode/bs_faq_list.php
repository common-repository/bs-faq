...
class Bs_faqs_shortcode
{
	
	public function __construct()
	{
		add_shortcode( 'bs-faqs-list', array($this,'bs_faq_list'),1);	
		...
		add_action('admin_print_footer_scripts', array($this,'bs_faq_shortcode_button_script_cc'));
		endif;	
	}
	
function bs_faq_list() { 
...
function bs_faq_shortcode_button_script_cc() 
{
    if(wp_script_is("quicktags"))
    {
        ?>
            <script type="text/javascript">
                ...
                function callback()
                {                  
                    QTags.insertContent("[bs-faqs-list]");
                }
            </script>
        <?php
    }
